ModuleList = {
    AllListItems = {Test = false}, -- Every List item you input --[[Figure out how to have an existing string key with a string attached (the task) and a bolean value assigned to it]]
